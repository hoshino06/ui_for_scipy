...
class LinearProg():
    '''
    線形計画問題を表現するクラス
    scipy.optimizeのlinprogのアダプタクラスとしての機能を提供
    linprogの使い方:
    ...
    def append_inequality(self, g):
        ...
        self.A_ub.append(a)
        self.b_ub.append(b)
    def append_bound(self, x_i, lower, upper):
...
class TestLinearProg(unittest.TestCase):
    ...
    def test_optimization(self):
        ...
        linprog.append_bound(x1, 0, None)
        linprog.append_bound(x2, 0, None)
        res = linprog.optimization()
